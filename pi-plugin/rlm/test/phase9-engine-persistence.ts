...
async function main(): Promise<void> {
  ...
  try {
    ...
    check("trail file exists after appendRow", existsSync(tp));
    ...
    const sidecarOk = await writeContextSidecar(cwd, dir, runId, "test context", false);
